...
public class LoginTPage2Activity extends Activity{ ContentProvider cp;
DatabaseManager dm;
String pName = "b.a";
...
this.setContentView(R.layout.activity_login_t_page2);
...
LoginTPage2Activity.this.finish();
 }
 }
);
...
textView2.setText(dm.getEntity(taken, "/taken/3/1"));
 }
	@Override
...
editText2.addTextChangedListener(new TextWatcher(){ 	@Override
	public void afterTextChanged(Editable s){ String en = "/taken/3/2";
dm.setEntity(taken, es, en, s.toString());
 }
	@Override
	public void beforeTextChanged(CharSequence s, int start, int count, int after){  }
...
editText2.setText(dm.getEntity(taken, "/taken/3/2"));
 }
	@Override
